...
title: September 2025 Transport & Environment Committee - Roundup
...
In response to this incredibly positive and comprehensive report on the successes of the City Centre West to East Link ('CCWEL'), the Conservative group fielded ward Councillor Joanne Mowat to plead the case for the _'five hundred residents penned in to their homes'_ when events are on at Murrayfield by the existence of a cycle lane near their properties. Thoughts and prayers with this isolated community at what must be a very difficult time, though not as difficult a time as I had keeping a straight face throughout this contribution.
...
* CCWEL along West Coates being set at a different level to both the carriageway and footway, which resulted in costs and time to completely rebuild drainage systems; instead, cycleways could by and large be at carriageway level to avoid this, except where appropriate; this learning can already be seen in implementations on Holyrood Rd, London Rd and Lasswade Rd;
* Around the phasing of projects; taking CCWEL forward as a whole project had some benefits, but projects may need to go forward in smaller parts in future due to the funding environment (Ed: lack of multi-year project funding). Some parts of CCWEL had finished designs that waited around for a year, year and a half before a contractor could be appointed because the whole project moves forward at the pace of its slowest part; phasing major projects in smaller parts could also deliver benefits sooner.
* For construction in High Street environments such as Roseburn Terrace, Councillors would remember an issue where asbestos was discover during footway works, assumedly part of an underground cellar ceiling repair in the past; because a large section of footway had been excavated already, the need to bring in specialist contractors for a small section of asbestos removal left a large section of footway unusable throughout which caused greater disruption than could have been planned for - so the team immediately began to have smaller sections of excavation carried out at a time for the remainder of CCWEL's implementation to avoid similar issues elsewhere.
